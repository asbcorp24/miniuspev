...
{
    protected $fillable = ['group_id','subject_id','academic_period_id','work_type_id','grade_weight','lesson_date','topic','lesson_kind','description'];
    ...
    public function materials(): HasMany { return $this->hasMany(LessonMaterial::class); }
}
