...
<thead><tr><th class="ps-3">Студент</th><th>Статус</th><th>Файлы</th><th>Комментарий студента</th><th style="min-width:300px">Проверка</th></tr></thead>
<tbody>
...
<tr>
    ...
    <td>
        @if($s)
        <form method="POST" action="{{ route('homeworks.grade',$s) }}" class="row g-2">@csrf
            ...
            <div class="col-3"><button class="btn btn-success w-100">Сохранить</button></div>
        </form>
