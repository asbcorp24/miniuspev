...
@section('content')
<div class="d-flex justify-content-between align-items-center mb-4"><div><h1 class="h3 mb-1">Итоговые оценки за семестр</h1><div class="text-muted">Взвешенный расчёт + ручное утверждение преподавателем</div></div></div>
